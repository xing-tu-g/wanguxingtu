...
// Helper: create text runs with formatting
...
function dataCell(text, width) {
    return new TableCell({
        ...
        width: { size: width || 25, type: WidthType.PERCENTAGE }
    });
}
...
function makeTable(headers, rows, colWidths) {
    const headerRow = new TableRow({
        children: headers.map(h => darkHeaderCell(h))
    });
    
    const dataRows = rows.map(row => {
        return new TableRow({
            children: row.map((cell, i) => {
                return dataCell(cell, colWidths ? colWidths[i] : 25);
            })
        });
    });
...
// ========== CHAPTER 1 ==========
children.push(makePara("第一章：项目概述", { heading: HeadingLevel.HEADING_1, pb: true, before: 400, after: 200 }));

children.push(makePara("1.1 核心乐趣假设", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
children.push(makePara("在华夏文明的星图上，用三国名将的魂棋进行一场自动战棋对决——选将、布阵、看他们在随机地形上自动厮杀，赢了就是你把一颗陨落的将星拉回了文明。", { after: 200 }));

children.push(makePara("1.2 设计支柱", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
children.push(makePara("1. 星图设定——所有玩法围绕星图、魂星、天缺展开，不做换皮三国", { after: 100 }));
...
children.push(makePara("1.3 产品定位", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
children.push(makePara("1.4 核心循环", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
children.push(makePara("获得武将 → 编辑卡组 → 对战 → 结算领奖。武将升级 ← 抽卡 ← 资源获取。天梯排位。", { after: 200 }));

children.push(makePara("1.5 反痛点设计", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
children.push(makePara("1.6 凭什么可能火", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
// ========== CHAPTER 2 ==========
children.push(makePara("第二章：世界观", { heading: HeadingLevel.HEADING_1, pb: true, before: 400, after: 200 }));

children.push(makePara("2.1 万古星图", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
children.push(makePara("2.2 天缺", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
children.push(makePara("2.3 弈天师", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
children.push(makePara("2.4 三国是起点", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
// ========== CHAPTER 3 ==========
children.push(makePara("第三章：对战系统", { heading: HeadingLevel.HEADING_1, pb: true, before: 400, after: 200 }));

children.push(makePara("3.1 通用规则", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
children.push(makePara("3.2 回合流程", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
children.push(makePara("3.3 部署规则", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
children.push(makePara("- 玩家可在己方半场任意空格部署武将", { after: 100 }));
children.push(makePara("- 星力等于武将召唤消耗值", { after: 200 }));

children.push(makePara("3.4 战斗内查看", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
// ========== CHAPTER 4 ==========
children.push(makePara("第四章：职业体系", { heading: HeadingLevel.HEADING_1, pb: true, before: 400, after: 200 }));

children.push(makePara("4.1 职业特性", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
children.push(makePara("4.2 属性标准模型", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
// ========== CHAPTER 5 ==========
children.push(makePara("第五章：策略博弈因素", { heading: HeadingLevel.HEADING_1, pb: true, before: 400, after: 200 }));

children.push(makePara("5.1 武将技能体系", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
children.push(makePara("5.2 地形系统", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
children.push(makePara("5.3 全局策略卡", { heading: HeadingLevel.HEADING_2, before: 300, after: 100 }));
...
// Since the file is too long, let me continue with the remaining chapters
// For brevity, I'll write the script to file and run it

console.log("Script prepared. All chapters need to be added.");
console.log("Due to length, please let me write the complete script to disk.");

// Export the makeTable and other functions for use
module.exports = { makePara, makeTable, makeTextRuns };
